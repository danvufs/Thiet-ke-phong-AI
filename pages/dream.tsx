    ...
    <div className="flex max-w-6xl mx-auto flex-col items-center justify-center py-2 min-h-screen bg-gradient-to-br from-indigo-800 to-gray-800">
      ...
      <main className="flex flex-1 w-full flex-col items-center justify-center text-center px-4 mt-4 sm:mb-0 mb-8">
        <h1 className="mx-auto max-w-4xl font-display text-4xl font-bold tracking-normal text-slate-100 sm:text-6xl mb-5">
          Tạo phòng <span className="text-blue-600">mơ ước</span> của bạn
        </h1>
        <ResizablePanel>
          <AnimatePresence mode="wait">
            <motion.div className="flex justify-between items-center w-full flex-col mt-4">
              ...
              {restoredImage && (
                <div>
                  Đây là phòng <b>{room.toLowerCase()}</b> của bạn đã được thay đổi theo dạng{" "}
              ...
              {restoredImage && originalPhoto && !sideBySide && (
                <div className="flex sm:space-x-4 sm:flex-row flex-col">
                  ...
                  <div className="sm:mt-0 mt-8">
                    <h2 className="mb-1 font-medium text-lg">Ảnh do AI tạo</h2>
