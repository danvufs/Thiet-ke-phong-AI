      ...
      <main className="flex flex-1 w-full flex-col items-center justify-center text-center px-4 sm:mt-20 mt-20">
        <h1 className="mx-auto max-w-4xl font-display text-5xl font-bold tracking-normal text-gray-300 sm:text-7xl">
          ...
          <span className="relative whitespace-nowrap text-blue-600">
            <SquigglyLines />
            <span className="relative">bằng trí tuệ nhân tạo (AI)</span>
          </span>{" "}
          cho mọi người
        </h1>
        ...
        <div className="flex justify-between items-center w-full flex-col sm:mt-10 mt-6">
          <div className="flex flex-col space-y-10 mt-4 mb-16">
            <div className="flex sm:space-x-8 sm:flex-row flex-col">
              <div>
                <h3 className="mb-1 font-medium text-lg">Hình gốc</h3>
                <Image
              ...
              <div className="sm:mt-0 mt-8">
                <h3 className="mb-1 font-medium text-lg">Hình mới được AI tạo</h3>
                <Image
